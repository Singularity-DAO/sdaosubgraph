...
export class SingDao__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class SingDao extends ethereum.SmartContract {
  static bind(address: Address): SingDao {
    return new SingDao("SingDao", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): SingDao__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new SingDao__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<SingDao__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SingDao__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
...
export class SetLockerCall extends ethereum.Call {
  get inputs(): SetLockerCall__Inputs {
    return new SetLockerCall__Inputs(this);
  }

  get outputs(): SetLockerCall__Outputs {
    return new SetLockerCall__Outputs(this);
  }
}

export class SetLockerCall__Inputs {
  _call: SetLockerCall;

  constructor(call: SetLockerCall) {
    this._call = call;
  }
...
export class SetLockerCall__Outputs {
  _call: SetLockerCall;
